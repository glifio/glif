...
// Source: github.com/glifio/glif/v2/journal (interfaces: Journal)
...
import (
	...
	journal "github.com/glifio/glif/v2/journal"
...
func (m *MockJournal) ReadEvents() ([]journal.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReadEvents")
...
func (mr *MockJournalMockRecorder) ReadEvents() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ReadEvents", reflect.TypeOf((*MockJournal)(nil).ReadEvents))
}
